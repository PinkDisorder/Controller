...
public class ConfigLoader : ModSystem {
	private const string ConfigName = "controller.json";
	...
	public override void Start(ICoreAPI api) {
		...
		// "condition": { "when": "Controller_ExampleProperty", "isValue": "true" }
		api.World.Config.SetBool("Controller_ExampleProperty", Config.ExampleConfigSetting);
	}
}